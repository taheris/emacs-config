...
(setq doom-font (font-spec :family "Monaco" :size 15)
      ...
      doom-variable-pitch-font (font-spec :family "Monaco" :size 15 :weight 'semi-light)
      doom-unicode-font (font-spec :family "JuliaMono")
      doom-serif-font (font-spec :family "Monaco" :size 15 :weight 'light))
#+end_src
...
#+begin_src emacs-lisp :tangle no
(defvar required-fonts '("Overpass" "JuliaMono" "Merriweather" "Alegreya"))
...
#+name: e
#+begin_src shell :tangle ~/bin/em :mkdirp yes :tangle-mode (identity #o755) :comments no
#!/usr/bin/env bash
force_tty=false
force_wait=false
stdin_mode=""
  ...
  (prin1-to-string
   `(package! org-mode
      :recipe (,@(cond ((and dev-key dev-pkg)
                       ...
                       (dev-key
                        (list :host nil :repo "git@code.orgmode.org:bzg/org-mode.git"))
                       (t
...
(setq org-directory "~/src/github.com/taheris/org"
      epa-file-encrypt-to '("git@taheris.net")
...
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p "~/Documents/roam/") "no" "packages.el")
...
(package! beancount :recipe (:host github :repo "beancount/beancount-mode")
  :pin "5be04a37d6a189f1680cb47d022a85d9faeba8fc")
#+end_src
...
(package! flatbuffers-mode
  :recipe (:host github :repo "Asalle/flatbuffers-mode" :files ("*.el"))
  :pin "8e7783db45a64c9456130fd0c108ac12d45a7789")
#+end_src
...
(package! protobuf-mode
  ...
  :pin "768bc823ef55889a143a98512aec8401f2b4abd3")
